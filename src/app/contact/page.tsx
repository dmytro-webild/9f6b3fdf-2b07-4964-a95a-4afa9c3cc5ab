      ...
      faqs={[
        {
          ...
          content: "Capital Cleaning proudly serves the entire Capital City metropolitan area and surrounding suburbs. Please contact us to confirm service availability in your specific location.",
        },
        {
          id: "2",
          title: "Are your cleaning products eco-friendly?",
          content: "Yes, we are committed to using eco-friendly and non-toxic cleaning products that are safe for your family, pets, and the environment. We can also accommodate special requests for specific products.",
        },
        {
          id: "3",
          title: "How do I book a cleaning service?",
          content: "You can easily book a service by filling out the contact form on this page, calling us directly, or sending an email. We'll respond quickly to discuss your needs and schedule your service.",
        },
        {
          id: "4",
          title: "What if I need to reschedule or cancel?",
          content: "We understand plans can change. Please notify us at least 24 hours in advance if you need to reschedule or cancel your appointment to avoid any cancellation fees.",
        },
      ]}
